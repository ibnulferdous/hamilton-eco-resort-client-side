...
const AboutSection = () => {
    return (
        <div className="home about overflow-hidden">
            <div className="little-description container py-8 px-2">
                <div className="row">
                    <div className="col">
            ...
            <div className="container">
                <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3">
                    ...
                    <div className="col">
                        <div>
                            <img src={home4} className="img-fluid pt-4 pt-lg-5" alt="resort" />
                        </div>
                    </div>
                    <div className="col">
                        <div className="pt-0 pt-lg-5">
                            <img src={home6} className="img-fluid pt-4 pt-lg-5" alt="resort" />
                        </div>
                    </div>
                </div>
            </div>
